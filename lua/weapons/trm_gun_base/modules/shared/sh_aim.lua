function SWEP:CanAim()
    ...
    if self:GetSprintDelta() > 0.1 or ( self.IronsightReload == false and self:IsReloading() ) or string.find(seq,"Holster") or string.find(seq,"Draw") then return false end  
    return true 
end
